                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>With a solid understanding of this process, you can save time, close deals quicker and support buyers and sellers with the home-buying process</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>including managing and tracking tenant information, accounting and billing, maintenance, and posting vacancies online</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p> provides potential buyers with key information about the property, such as its price, location, descriptions, and photos</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Such as investing money into a business, property, securities, a house, stocks, etc. with the purpose of generating income and obtaining a profit</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Trusted by thousands of satisfied clients
Expertise in luxury and residential real estate<p>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>luxurious features and quality craftsmanship of the property, as well as the exceptional lifestyle it offers to potential buyers</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Whether you're buying, selling, or investing in real estate, our team of experienced agents is here to help. Contact us today to schedule a consultation and take the first step towards achieving your real estate goals</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Schedule a consultation with one of our experienced agents to discuss your real estate goals, preferences, and timeline</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>When you've identified properties of interest, we'll schedule viewings at your convenience so you can see the properties in person</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our goal is to make the closing process as smooth and efficient as possible, so you can move into your new home with confidence</p>
                        </div>
                    </div>
                </div>
            </div>
